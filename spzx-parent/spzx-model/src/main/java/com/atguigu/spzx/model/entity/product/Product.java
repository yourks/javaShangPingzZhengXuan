...
public class Product extends BaseEntity {
	...
	private String unitName;				// 7.计量单位
	...
	private Integer status;					// 10线上状态：0-初始值，1-上架，-1-自主下架

	@Schema(description = "审核状态")
	private Integer auditStatus;			// 8.审核状态

	@Schema(description = "审核信息")
	private String auditMessage;			// 9.审核信息

	// 扩展的属性，用来封装响应的数据
	@Schema(description = "品牌名称")
	private String brandName;				// 3.品牌

	@Schema(description = "一级分类名称")
	private String category1Name;			// 4.一级分类

	@Schema(description = "二级分类名称")
	private String category2Name;			// 5.二级分类

	@Schema(description = "三级分类名称")
	private String category3Name;			// 6.三级分类

	@Schema(description = "sku列表集合")
	private List<ProductSku> productSkuList;		// sku列表集合

	@Schema(description = "图片详情列表")
	private String detailsImageUrls;				// 1.图片详情列表
